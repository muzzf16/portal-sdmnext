...
3. **[PRIORITAS MENENGAH] Ukuran Git History Besar (269 MB)**
   ...
   * *Aksi*: Lakukan pembersihan riwayat Git (*history rewrite*) menggunakan `git-filter-repo` atau BFG Repo-Cleaner. *Catatan*: Ini membutuhkan koordinasi ketat sebelum dijalankan agar seluruh dev/server melakukan re-clone guna menghindari konflik commit history.
4. **[PRIORITAS RENDAH] Tumpukan Berkas SQLite Cadangan (12 Berkas Backup)**
