...
const KpiMonitoringView: React.FC<KpiMonitoringViewProps> = ({ 
    ...
    return (
        <div className="bg-white rounded-lg shadow print:shadow-none mt-6 p-6 print:m-0 print:p-0">
            ...
            <div className="hidden print:block mb-8 print:mb-2 pb-6 print:pb-2 border-b-2 border-gray-100">
                <div className="grid grid-cols-2 gap-8 print:gap-4">
                    <div className="bg-gray-50 p-4 print:p-2 rounded-xl border border-gray-100">
                        <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mb-1 print:mb-0.5">Nama Pegawai</p>
                        <p className="text-base print:text-xs font-extrabold text-blue-900">{selectedEmployeeName}</p>
                    </div>
                    <div className="bg-gray-50 p-4 print:p-2 rounded-xl border border-gray-100">
                        <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mb-1 print:mb-0.5">Periode Laporan</p>
                        <p className="text-base print:text-xs font-extrabold text-indigo-900">{selectedPeriodLabel}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 print:grid-cols-3 gap-6 mb-8 print:mb-4">
                {/* WLA Card */}
                <div className="bg-blue-50 rounded-xl p-5 print:p-3 border border-blue-100 shadow-sm print:shadow-none relative overflow-hidden">
                    ...
                    <h3 className="text-blue-800 font-semibold mb-1 relative z-10 print:text-[10px]">Beban Kerja / FTE (80%)</h3>
                    ...
                    <div className="text-3xl font-bold text-blue-900 mb-1 relative z-10 print:text-base">
                        {summary.wlaPercentage.toFixed(1)}% <span className="text-lg font-normal text-blue-700 print:hidden">/ 100%</span>
                    </div>
                    <div className="text-sm text-blue-700 mt-4 print:mt-1 pt-3 print:pt-1 border-t border-blue-200 relative z-10 print:text-[10px]">
                        Poin ke Total: <b className="text-lg print:text-[10px]">{summary.finalWla.toFixed(1)}%</b>
                    </div>
                </div>

                {/* KPI Khusus Card */}
                <div className="bg-purple-50 rounded-xl p-5 print:p-3 border border-purple-100 shadow-sm print:shadow-none relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                    ...
                    <h3 className="text-purple-800 font-semibold mb-1 relative z-10 print:text-[10px]">Pencapaian Khusus (20%)</h3>
                    <p className="text-sm text-purple-600 mb-3 relative z-10 print:hidden">{summary.khususRawCount} Item KPI</p>
                    <div className="text-3xl font-bold text-purple-900 mb-1 relative z-10 print:text-base">
                        {summary.khususPercentage.toFixed(1)}% <span className="text-lg font-normal text-purple-700 print:hidden">/ 100%</span>
                    </div>
                    <div className="text-sm text-purple-700 mt-4 print:mt-1 pt-3 print:pt-1 border-t border-purple-200 relative z-10 print:text-[10px]">
                        Poin ke Total: <b className="text-lg print:text-[10px]">{summary.finalKhusus.toFixed(1)}%</b>
                    </div>
                </div>

                {/* Total Achievement */}
                <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-5 print:p-3 border border-green-200 flex flex-col justify-center shadow-sm print:shadow-none relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                    ...
                    <div className="mt-3 print:mt-1 relative z-10 flex items-center">
                        <span className={clsx("px-3 py-1 print:px-2 print:py-0.5 rounded-full text-xs print:text-[9px] font-bold border", getScoreCategory(summary.finalTotal).className)}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 print:grid-cols-2 gap-8 print:gap-4">
                <div>
                    <h4 className="font-semibold text-gray-800 mb-3 flex items-center print:text-sm print:mb-2">
                    ...
                    <div className="bg-white border rounded-lg overflow-hidden shadow-sm print:shadow-none">
                        <table className="min-w-full divide-y divide-gray-200 text-sm print:text-[8px]">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-4 py-3 print:px-1 print:py-0.5 text-left text-xs print:text-[8px] font-medium text-gray-500 uppercase tracking-wider">Aktivitas</th>
                                    <th className="px-4 py-3 print:px-1 print:py-0.5 text-center text-xs print:text-[8px] font-medium text-gray-500 uppercase tracking-wider">Frekuensi</th>
                                    <th className="px-4 py-3 print:px-1 print:py-0.5 text-center text-xs print:text-[8px] font-medium text-gray-500 uppercase tracking-wider">Durasi Total</th>
                                </tr>
                            </thead>
                                ...
                                {summary.wlaActivityItems.map((item, idx) => (
                                    <tr key={idx} className="hover:bg-blue-50/50 transition-colors print:break-inside-avoid">
                                        <td className="px-4 py-3 print:px-1 print:py-0.5">
                                            <div className="text-gray-900 font-medium print:font-normal">{item.activityName}</div>
                                            {item.category && <div className="text-xs print:text-[7px] text-gray-400">{item.category}</div>}
                                        </td>
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-center text-gray-700">{item.totalFrekuensi}x</td>
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-center font-medium text-blue-700">{item.totalDurasi} menit</td>
                                    </tr>
                                ))}
                            ...
                            {summary.wlaActivityItems.length > 0 && (
                                <tfoot className="bg-gray-50 divide-y divide-gray-200 border-t border-gray-200">
                                    <tr className="print:break-inside-avoid">
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-red-600 font-bold text-center">TOTAL</td>
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-red-600 font-bold text-center">{summary.totalFrekuensi}x</td>
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-center">
                                            ...
                                            <div className="text-xs print:text-[7px] text-gray-500">
                                    ...
                                    <tr className="print:break-inside-avoid">
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 font-bold text-center" colSpan={2}>Beban (FTE)</td>
                                        <td className={`px-4 py-3 print:px-1 print:py-0.5 text-center font-bold text-lg print:text-xs ${getFteStatus(summary.wlaPercentage).color}`}>
                ...
                <div>
                    ...
                    <div className="bg-white border rounded-lg overflow-hidden shadow-sm print:shadow-none">
                        <table className="min-w-full divide-y divide-gray-200 text-sm print:text-[8px]">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-4 py-3 print:px-1 print:py-0.5 text-left text-xs print:text-[8px] font-medium text-gray-500 uppercase tracking-wider">Nama KPI</th>
                                    <th className="px-4 py-3 print:px-1 print:py-0.5 text-center text-xs print:text-[8px] font-medium text-gray-500 uppercase tracking-wider">Realisasi / Target</th>
                                    <th className="px-4 py-3 print:px-1 print:py-0.5 text-center text-xs print:text-[8px] font-medium text-gray-500 uppercase tracking-wider">Capaian</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-200">
                                {summary.khususItems.map(k => (
                                    <tr key={k.id} className="hover:bg-purple-50/50 transition-colors print:break-inside-avoid">
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-gray-900 font-medium print:font-normal">{k.kpiName}</td>
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-center">
                                            <div className="font-bold print:font-semibold text-gray-700">
                                                {formatKpiValue(Number(k.actualValue), k.targetUnit)}
                                            </div>
                                            <div className="text-[10px] print:text-[7px] text-gray-400">
                                                Target: {formatKpiValue(Number(k.targetValue), k.targetUnit)}
                                            </div>
                                        </td>
                                        <td className="px-4 py-3 print:px-1 print:py-0.5 text-center font-semibold text-purple-700">{k.pct.toFixed(1)}%</td>
                                    </tr>
                                ))}
                            ...
                            <tfoot className="bg-gray-50 divide-y divide-gray-200 border-t border-gray-200">
                                <tr className="print:break-inside-avoid">
                                    <td className="px-4 py-3 print:px-1 print:py-0.5 text-red-600 font-bold text-center">TOTAL</td>
                                    <td className="px-4 py-3 print:px-1 print:py-0.5 text-red-600 font-bold text-center text-xs print:text-[8px]">
                                        {formatNominal(summary.khususItems.filter(i => i.isNominal).reduce((acc, curr) => acc + (Number(curr.actualValue) || 0), 0))} <br/>
                                        <span className="text-[10px] print:text-[7px] opacity-70">vs Target {formatNominal(summary.khususItems.filter(i => i.isNominal).reduce((acc, curr) => acc + (Number(curr.targetValue) || 0), 0))}</span>
                                    </td>
                                    <td className="px-4 py-3 print:px-1 print:py-0.5 text-red-600 font-bold text-center">
                    ...
                    {/* Signature Area - Moved below KPI Khusus */}
                    <div className="mt-8 print:mt-6 text-center text-black font-medium pb-4 print:pb-0 pt-4 print:pt-2 text-sm print:text-xs w-full print:break-inside-avoid bg-transparent border-none">
                        <p className="mb-8 print:mb-4">Mengetahui</p>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col items-center">
                                <p className="font-semibold mb-20 print:mb-10">Direktur Utama</p>
                                <div className="border-t border-black w-full max-w-[150px] pt-2 px-1">
                                    <p className="font-bold uppercase text-xs print:text-[9px]">{directors?.utama || 'SAPTO NUGROHO SE.,MSI'}</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-center">
                                <p className="font-semibold mb-20 print:mb-10">Direktur YMFK</p>
                                <div className="border-t border-black w-full max-w-[150px] pt-2 px-1">
                                    <p className="font-bold uppercase text-xs print:text-[9px]">{directors?.ymfk || 'IFAN ARDANA ,SE.,MSI'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
