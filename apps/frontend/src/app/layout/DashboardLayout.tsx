...
import {
  ...
  ChevronLeft, ChevronRight, LogOut, User, Bell, Shield, Database, Archive
} from 'lucide-react';
  ...
  const navSections: NavSection[] = useMemo(() => [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/dashboard/arsip-dokumen', icon: <Archive size={18} />, text: 'Arsip Dokumen', roles: ['admin', 'pimpinan', 'supervisor', 'employee'] },
        { to: '/dashboard/audit-log', icon: <Shield size={18} />, text: 'Audit Log', roles: ['admin'] },
        { to: '/dashboard/backup', icon: <Database size={18} />, text: 'Backup & Restore', roles: ['admin'] },
