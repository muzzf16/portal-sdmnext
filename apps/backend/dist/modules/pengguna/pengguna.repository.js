    ...
    async create(userData) {
        ...
        try {
            if (userData.employeeId) {
                await db.run('INSERT INTO pengguna (id, name, email, password, role, employeeId) VALUES (?,?,?,?,?,?)', [newUserId, userData.name, userData.email, hashedPassword, userData.role || 'employee', userData.employeeId]);
            }
            else {
