...
router.post('/bulk', uploadMiddleware_1.uploadDocument.any(), log_aktivitas_harian_controller_1.default.createBulkLog);
router.post('/', uploadMiddleware_1.uploadDocument.any(), log_aktivitas_harian_controller_1.default.createLog);
